    ...
    <div class="row">
        ...
        <div class="card-body">
          <form class="theForm" action=" {{ route('user.edit', $user) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
          <div class="card col-xs-12 col-sm-8 col-md-6" style="justify-content: center;">

              <h2>Edit your user, {{ Auth::user()->name }} {{ Auth::user()->surname }}</h2><hr>
                  ...
                  <div class="form-group row m-0 p-0">
                    <div class="col-md-6 offset-md-3 text-center">
                      <button type="submit" class="btn btn-md btn-primary" name="button">Update</button>
